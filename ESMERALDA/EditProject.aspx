            ...
            <div id="metadata" runat="server" class="clearfix">
                ...
                <table border="1px">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            Project ID: <asp:Label ID="lblMetadata_projectid" runat="server" Text="Label"></asp:Label>
                        </td>
                    </tr>
                </table>
                <asp:LinkButton ID="btn_SaveMetadata" runat="server" OnClick="btn_SaveMetadata_Click" CssClass="squarebutton"><span>Save Metadata</span></asp:LinkButton>
            </div>            
            <br />
