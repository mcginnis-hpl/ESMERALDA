    ...
    /*public class Program : EsmeraldaEntity
    {
        ...
        public override string GetMetadata(Dataset.MetadataFormat format)
        {
            ...
            if (format == MetadataFormat.XML)
            {
                ...
                {
                    List<string> vals = GetMetadataValueArray(s);
            ...
            {
                ret = "Program Name: " + GetMetadataValue("title") + Environment.NewLine;
                ret += Environment.NewLine;
                ret += "Acronym: " + GetMetadataValue("acronym") + Environment.NewLine;
                ret += Environment.NewLine;
                ret += "Program URL: " + GetMetadataValue("url") + Environment.NewLine;
                Person pi = null;
                foreach (PersonRelationship pr in Relationships)
                {
        ...
        {
            string cmd = "SELECT bound, value FROM v_ESMERALDA_BoundsTree WHERE program_id='" + ID.ToString() + "'";
            SqlCommand query = new SqlCommand();
